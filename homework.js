...
function arrowSorted() {
    
    for(let i of document.querySelectorAll('[data-attr]')) {
        i.onclick = (e) => { 
            for (let item of document.querySelectorAll('[data-attr]')){
                item.classList.remove('bi', 'bi-arrow-down', 'bi-arrow-up', 'bg-warning', 'shadow', 'text-center');
            }
            e.target.classList.add('bi', 'bi-arrow-down', 'bg-warning', 'shadow', 'text-center');
            ...
            let sortedCountries = countries.sort((a, b) => {
                if (isSorted) {
                    e.target.classList.toggle('bi-arrow-up', 'bi-arrow-down');
            ...
            isSorted ? e.currentTarget.removeAttribute('data-sorted') : e.currentTarget.setAttribute('data-sorted', '+');
